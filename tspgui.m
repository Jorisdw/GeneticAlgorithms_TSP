...
CROSSOVER = 'MyCrossover';  % default crossover operator
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
crossover = uicontrol(ph,'Style','popupmenu', 'String',{'xalt_edges','MyCrossover'}, 'Value',1,'Position',[10 50 130 20],'Callback',@crossover_Callback);
